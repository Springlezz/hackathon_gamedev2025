import AcidFlowCorner from '../entities/acid-flow-corner.js';
import AcidFlow from '../entities/acid-flow.js';
import Acid from '../entities/acid.js';
...
export default class Level3 extends Level {
    ...
    boxes = [
        new BoxSmall(new Vector2(0, 200), true)
    ];
